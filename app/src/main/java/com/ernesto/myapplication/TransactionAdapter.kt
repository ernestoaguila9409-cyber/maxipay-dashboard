...
class TransactionAdapter(
    ...
    override fun onBindViewHolder(holder: TransactionViewHolder, position: Int) {
        ...
        if (isStandaloneRefund) {
            ...
            holder.txtCard.text = "Refund  $methodLabel  -${String.format("$%.2f", saleAmount)}"
            holder.txtType.text = if (sale.paymentType.equals("Cash", true)) "Cash Refund" else "Card Refund"
            ...
            holder.txtAmount.text = String.format("$%.2f", netAmount)
        }
