...
/**
 * Same behavior as main POS [com.ernesto.myapplication.PosDevicePresenceSync]:
 * periodic Firestore [lastSeen] while the app is in the foreground so the dashboard Devices page
 * stays "Online" (threshold 2 minutes on the web).
 */
