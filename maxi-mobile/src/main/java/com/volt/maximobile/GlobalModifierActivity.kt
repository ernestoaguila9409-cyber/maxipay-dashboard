...
class GlobalModifierActivity : AppCompatActivity() {
    ...
    private fun buildAddOptionDialog(
        ...
        val wrapped = ModifierOptionKeypadHost.wrap(
            this,
            form,
            title = "Add Option",
        )
        ...
        val dialog = MaterialAlertDialogBuilder(this, R.style.ThemeOverlay_MyApplication_MaterialAlertDialog)
            .setView(wrapped.root)
            .create()

        dialog.setOnShowListener {
            ModifierOptionKeypadHost.configureDialogWindow(dialog)
        }

        wrapped.btnCancel.setOnClickListener { dialog.dismiss() }
        wrapped.btnSave.setOnClickListener {
