...
import com.volt.shared.engine.ReportBuilder
import com.volt.shared.engine.ReportData
import com.volt.shared.engine.ReportEngine
import com.volt.shared.engine.ReportRow
import com.volt.shared.engine.ReportSection
...
class ReportPreviewActivity : AppCompatActivity() {
    ...
    private fun loadMenuPerformance(start: Date, end: Date, employee: String?) {
        var items = emptyList<com.volt.shared.engine.ItemSalesRow>()
        var categories = emptyList<com.volt.shared.engine.CategorySalesRow>()
        var modifiers = emptyList<com.volt.shared.engine.ModifierSalesRow>()
        var completed = 0
        val lock = Any()
