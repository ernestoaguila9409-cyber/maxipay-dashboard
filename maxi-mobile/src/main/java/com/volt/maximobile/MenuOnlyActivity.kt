...
class MenuOnlyActivity : AppCompatActivity() {
    ...
    private lateinit var itemScreen: View
    private lateinit var btnInventoryBack: View
    ...
    private var showingItemsScreen: Boolean = false
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        itemScreen = findViewById(R.id.itemScreen)
        ...
        itemsBackCallback = object : OnBackPressedCallback(false) {
            override fun handleOnBackPressed() {
                showCategoriesScreen()
            }
        }
        onBackPressedDispatcher.addCallback(this, itemsBackCallback)

        btnInventoryBack.setOnClickListener { showCategoriesScreen() }

        btnAddCategoryFab.setOnClickListener {
            ...
            loadSubcategories {
                MerchantFirestore.col("Categories")
                    ...
                    .addOnSuccessListener { documents ->
                        ...
                        if (showingItemsScreen && selectedCategoryId != null) {
                            buildSubcategoryChips(selectedCategoryId!!)
                            loadItems(selectedCategoryId!!)
                        }
                    }
    ...
    private fun showCategoriesScreen() {
        ...
        itemScreen.visibility = View.GONE
        btnAddCategoryFab.visibility = View.VISIBLE
        btnAddItem.visibility = View.GONE
        btnInventoryBack.visibility = View.GONE
        txtInventoryTitle.text = "Inventory"
        itemsBackCallback.isEnabled = false
    }

    private fun showItemsScreen() {
        showingItemsScreen = true
        categoryRecycler.visibility = View.GONE
        itemScreen.visibility = View.VISIBLE
        btnAddCategoryFab.visibility = View.GONE
        btnAddItem.visibility = View.VISIBLE
        btnInventoryBack.visibility = View.VISIBLE
        txtInventoryTitle.text = selectedCategoryName.ifBlank { "Inventory" }
        itemsBackCallback.isEnabled = true
    }
